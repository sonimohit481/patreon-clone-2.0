  ...
  return (
    <>
      {token === null ? (
                ...
                <Stack spacing={10}>
                  ...
                  <Stack spacing={3}>
                    ...
                    >
                      <img
                        style={{ width: "22px", paddingRight: "5px" }}
                        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTb6CEJg9INtyaf2J8APb69gsPOznqz7eQDw&usqp=CAU"
                        alt=""
                      />
        ...
        <Navigate to={"/creatorhome"}></Navigate>
      )}
    </>
  );
};
