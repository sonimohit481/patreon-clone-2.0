...
export const Basic = () => {
  ...
  const { creatorType, tiers, posts } = profile;
  const profileFetch = () => {
      ...
      <div style={{ display: "flex" }}>
        <div id="editPageBasics">
          ...
          >
            ...
            >
              ...
              <Input
                name="creatormode_name"
                value={profile.creatormode_name}
              ...
              <div>
                <RadioGroup onChange={handlecorrectSounds} value={value}>
                  <Stack direction="column">
                    <Radio value="1">
                      {profile.creatormode_name} <b>is creating</b>
                    </Radio>
                    <Radio value="2">
                      {profile.creatormode_name} <b>are creating</b>
                    </Radio>
                  </Stack>
                </RadioGroup>
              </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div>
                <label htmlFor="">
                  ...
                  <Input
                    name="patreonPageUrl"
                    value={profile.patreonPageUrl}
                    onChange={handleOnchange}
                    width={"200px"}
                    placeholder="creatoraccount"
                  />
                </label>
              </div>
            </div>
          ...
          <div>
            ...
            <div>
              <Text fontSize="sm">
                ...
                land on your page, so make sure you <br />
                paint a compelling picture of how they can join you on this
                journey.
              </Text>
            </div>
            <div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <div>
                <label htmlFor="">
                  <Input
                    name="aboutPatreonPage"
                    value={profile.aboutPatreonPage}
                    onChange={handleOnchange}
                    variant="filled"
                    width={"300px"}
        ...
        <div>
          <RightSideBar
            ...
            isintroVideoUrl={isintroVideoUrl}
          />
        </div>
      </div>
    </>
